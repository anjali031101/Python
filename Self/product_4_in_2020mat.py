matrix_str = """89 90 95 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
# Split string on ';' to get rows
rows = matrix_str.split('\n')

# Create empty list to hold final 2D list
g = []

# Iterate over rows 
for row in rows:
  # Split on space to get columns 
  cols = row.split(' ')

  # Convert strings to ints
  cols = [int(col) for col in cols]

  # Append cols to matrix 
  g.append(cols)
