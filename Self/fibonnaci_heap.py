...
print("The minimum value of fibonnaci heap is : {}".format(fibonnaciHeap.get_min()))

print("The minimum value removed is : {}".format(fibonnaciHeap.extract_min()))
